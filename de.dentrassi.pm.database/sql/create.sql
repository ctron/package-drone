...
CREATE TABLE CHANNELS (
    ...
    AGR_NUM_WARN  NUMERIC NOT NULL DEFAULT 0,
    AGR_NUM_ERR   NUMERIC NOT NULL DEFAULT 0,
...
-- a table holding validation results
...
-- a table assigning validation messages with artifacts
...
CREATE TABLE JOBS (
    ...
    CURRENT_WORK_LABEL  VARCHAR(255),
